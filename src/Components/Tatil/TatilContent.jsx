      ...
      <>
        <div className="mb-16 m-10 m:m-20 flex flex-wrap">
          ...
          <div className="w-full shrink-0 grow-0 basis-auto lg:w-6/12 lg:pl-6">
            <h3 className="mb-4 text-3xl font-bold">Yurt Dışı Turlar</h3>
        ...
        <div className="mb-16 m-10 m:m-20 flex flex-wrap lg:flex-row-reverse">
          ...
          <div className="w-full shrink-0 grow-0 basis-auto lg:w-6/12 lg:pl-6">
            <h3 className="mb-4 text-3xl font-bold">Yurt İçi Turlar</h3>
            <p className="text-neutral-900">
              Yurt İçinde Keşfetmeye Hazır mısınız? Türkiye'nin Görülmesi
              Gereken Güzelliklerini Bir Araya Getirdik! Doğanın Büyüleyici
              Dokusunu, Tarihin Derin İzlerini ve Lezzetli Mutfağını Keşfedin!
              Profesyonel Rehberlerimizle Anılarınızı Ölümsüzleştirin.
              Hayalinizdeki Tatil Rüyası, Bizimle Gerçeğe Dönüşüyor!
            </p>
            <Link to="/yurticiturlar">
              <button class="bg-neutral-900 hover:bg-blue-300 mt-5 text-white font-light py-2 px-4 rounded-full transition">
                Yurt İçi Turları İncele
              </button>
            </Link>
          </div>
        </div>
